...
\begin{enumerate}[1.]
	\item \textbf{Usable}: en otras palabras se espera que todas sus componentes de interfaz, para manejar \textit{sets} de reuniones de un proyecto. Sean amigables de forma tal que exhiban usabilidad, existen heurísticas que la miden \fullcite{nielsen1990heuristic}.
	\item \textbf{Trazable}: es decir, el sistema debe tener una forma visual de administrar las relaciones causales entre los elementos dialógicos que se dan en las reuniones: acuerdos, compromisos, dudas y desacuerdos, en base a la teoría del diálogo \fullcite{RN24}
